...
function displayBagSummary(){
    ...
    let totalItem = bagItembojects.length;
    let totalMRP = 0;
    let totalDiscount = 0;
    let finalpayment = 0;

    bagItembojects.forEach(bagItem =>{
    ...
    bagSummaryElement.innerHTML=`<div class="bag-details-container">
          ...
          <button class="btn-place-order">
            <div class="css-xjhrni"><a href="place_order.html">PLACE ORDER</a></div>
          </button>`;
}

function loadBagItemsObjects(){
    console.log(bagItems);
    bagItembojects = bagItems.map(itemId => {
...
function displayBagItems()
{
    ...
    let innerHTML = '';
    bagItembojects.forEach(bagItems => {
